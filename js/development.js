...
function ubicarFooter(){
   // var tam = /*parseInt($('.contact').css('height')) + */parseInt($('header').css('height')) + parseInt($('header').css('padding-top')) + parseInt($('header').css('padding-bottom')) + parseInt($('.section_menu').css('height'))
